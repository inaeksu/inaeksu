...
<div id="main">
    <div id="toppanel">
        <div id="wrapper">
            <div id="userpanel">
                <ul id="menuLng">
                    <li><a id="lng-current"><?php $langs = Localization::getAllLangs(); echo($langs[Localization::getLocale()]); ?></a>
                        <ul id="menuLngItems">
                        	<?php foreach(Localization::getAllLangs() as $key=>$value){ ?>
                        		<li id="lng-<?php echo $key; ?>" data-lng="<?php echo $key; ?>"><a href="javascript:void(0)"><?php echo $value; ?></a></li>
                        	<?php } ?>
                        </ul>
                    </li>
                </ul>
    ...
    <div id="headerblock">
        <div id="wrapper">
            ...
            <div id="logoMidd">
                <p><?php echo Localization::getText('Інститут Автоматики, Електроніки та Комп\'ютерних Систем Управління'); ?></p>
            </div>
            <div id="logoRight">
